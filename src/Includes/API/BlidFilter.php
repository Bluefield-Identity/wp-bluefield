...
class BlidFilter extends BlidBaseApi {
    ...
    public function create_recommendation() {
        $args = [
            ...
            'clientVar1' => $this->client_vars->get_client_vars_as_value('clientVar1'),
            'clientVar2' => $this->client_vars->get_client_vars_as_value('clientVar2'),
            'clientVar3' => $this->client_vars->get_client_vars_as_value('clientVar3'),
            'clientVar4' => $this->client_vars->get_client_vars_as_value('clientVar4'),
            'clientVar5' => $this->client_vars->get_client_vars_as_value('clientVar5'),
            'clientVar6' => $this->client_vars->get_client_vars_as_value('clientVar6'),
